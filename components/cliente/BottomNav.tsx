...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="sticky bottom-0 z-[var(--z-sticky)] flex shrink-0 items-center justify-around gap-1 border-t border-line bg-elevated px-3 pb-[calc(env(safe-area-inset-bottom)+10px)] pt-2.5"
    >
